            ...
            <TimelineItem key={hackathon.title + hackathon.dates} className="w-full flex items-start justify-between gap-10">
              ...
              <div className="flex flex-1 flex-col justify-start gap-2 min-w-0">
                ...
                {hackathon.description && (
                  <div className="prose prose-sm max-w-full text-pretty font-sans text-muted-foreground leading-relaxed wrap-break-word dark:prose-invert">
                    <Markdown remarkPlugins={[remarkGfm]}>{hackathon.description}</Markdown>
                  </div>
                )}
