...
export const DATA = {
  ...
  summary:
    "I build the tools other engineers use to ship — internal platforms, developer portals, the golden paths that make the right way the easy way. Most of my career has lived at that intersection: not just writing the code, but making it obvious how to write good code, faster.\n\nThese days that means thinking a lot about how AI agents fit into developer platforms — not as a novelty bolted on top, but as another way for a developer to reach the same paved paths they'd get from a UI or a CLI. I like tinkering with new tools long enough to know whether they're worth building on, and I'm not shy about pushing for the newer approach when it's actually better, not just newer.\n\nI've moved between individual contributor and team lead more than once over the years, and I still like both. This site (and the blog on it) is mostly a place to think out loud about whatever I'm tinkering with — platform engineering, AI tooling, or whatever rabbit hole I've fallen into that week.",
