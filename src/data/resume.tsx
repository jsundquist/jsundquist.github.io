...
export const DATA = {
  ...
  summary:
    "I've spent my career building the tools that make other engineers' work easier — developer platforms, automation, the unglamorous infrastructure that quietly holds everything together. I like problems that don't have a clean answer yet, and I'd rather be handed the requirements and left to figure it out than given a spec to execute.\n\nThat same instinct follows me off the clock. I volunteer as a coach for my son's youth baseball team and sit on the board that helps keep the program running, because I like being part of something bigger than just my own work. I'm also an avid runner who's run multiple marathons, which is either discipline or stubbornness, depending on the week. I like systems, I like running, and I like figuring out how things work well enough to make them work better.",
